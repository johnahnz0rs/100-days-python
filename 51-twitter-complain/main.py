...
class InternetSpeedTwitterBot():
    ...
    def tweeter_a_complaint(self, down, up):
        print(f"tweeter_a_complaint(down={down}, up={up})") # dev
        ...
        while not login_pw:
            try:
                ...
                login_pw = self.driver.find_element(By.XPATH, '//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div/div[3]/div/label/div/div[2]/div[1]/input')
            except NoSuchElementException:
        ...
        while not tweet_textarea:
            try:
                ...
                tweet_textarea = self.driver.find_element(By.XPATH, '//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div[1]/div/div[3]/div/div[2]/div[1]/div/div/div/div[2]/div[1]/div/div/div/div/div/div[2]/div/div/div/div/label/div[1]/div/div/div/div/div/div[2]/div/div/div/div/span')
            except NoSuchElementException:
        ...
        print(f"prepping tweet - here's the msg:\n{tweeter_msg}")
        ...
        print("clicking tweet button to send tweet")
        tweet_button.click()
    ...
    def get_internet_speed(self):
        ...
        while not start_speed_test_button:
            try:
                ...
                time.sleep(1)
        print("clicking button to start the speed test")
...
my_down_speed = my_internet_speeds["down_speed"]
my_up_speed = my_internet_speeds["up_speed"]
# print(f"speeds:\n{my_internet_speeds}")


# if internet is slow, then tweeter at whomstever
# if my_down_speed < GUARANTEED_DOWN or my_up_speed < GUARANTEED_UP:
if my_down_speed < 9999 or my_up_speed < 100: # dev
    t_bot.tweeter_a_complaint(down=my_down_speed, up=my_up_speed)
